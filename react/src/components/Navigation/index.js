...
const Navigation = () => {
    ...
    // If previous element was clicked
    useEffect( () => {
        if(elementClicked){
            console.log('zadek', elementClicked.targetId);
            window.scrollTo(0, document.getElementById(elementClicked.targetId))
        }
    ...
    const handleActive = (e) => {
        e.preventDefault();
        setElementClicked(e.currentTarget);
    }
    
    // click on the anchor, which has an ID
    
    

    return(
        <Nav>
            <a className="nav__link" targetId="hours" href="#hours" onClick={handleActive}>
                ...
                <span>Ordinační hodiny</span></a>
            <a className="nav__link" targetId="about" href="#about" onClick={handleActive}>
                <svg className="svg-icon" enableBackground="new 0 0 512 512" version="1.1" viewBox="0 0 512 512"
                ...
                <span>služby</span></a>
            <a className="nav__link" href="#end" onClick={handleActive}>
                <svg className="svg-icon" enableBackground="new 0 0 426.667 426.667" version="1.1" viewBox="0 0 426.67 426.67"
                     xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
		<path d="m213.33 0c-82.453 0-149.33 66.88-149.33 149.33 0 112 149.33 277.33 149.33 277.33s149.33-165.33 149.33-277.33c1e-3 -82.453-66.879-149.33-149.33-149.33zm0 202.67c-29.44 0-53.333-23.893-53.333-53.333s23.893-53.334 53.333-53.334 53.333 23.893 53.333 53.333-23.893 53.334-53.333 53.334z"/>
            ...
            <a className="nav__link" href="#contact" onClick={handleActive}>
        <svg className="svg-icon" enableBackground="new 0 0 511.874 511.874" version="1.1" viewBox="0 0 511.87 511.87" xmlns="http://www.w3.org/2000/svg">
